	...
	var rotateFn = function (awards, angles, txt){
		...
		$('#rotate').rotate({
			...
			callback:function (){
				$('#kq10 span').html(txt);
				bRotate = !bRotate;
				$('#quaydone > .q').html('<div class="btn_muthem"><a href="quay20k.html">Quay thêm</a> <a href="/" class="btnxn">Trang chủ</a></div>');
				$('#pointer10').hide();
				$.magnificPopup.open({
				  items: {
				    src: '#res'
	...
	var rotateFn5 = function (awards, angles, txt){
		...
		$('#rotate').rotate({
			...
			callback:function (){
				$('#kq50 span').html(txt);
				bRotate = !bRotate;
				$('#quaydone > .q').html('<div class="btn_muthem"><a href="quay50k.html">Quay thêm</a> <a href="/" class="btnxn">Trang chủ</a></div>');
				$('#pointer50').hide();
				$.magnificPopup.open({
				  items: {
				    src: '#res'
...
$('#muangay10').click(function (){
	$.ajax({
		...
		success: function(json) {
				...
				window.location.href = 'quay20k.html';
...
$('#muangay50').click(function (){
	$.ajax({
		...
		success: function(json) {
				...
				window.location.href = '/quay50k.html';
