...
<input type="text" class="form-control" name="taikhoan" value="" placeholder="Tài khoản của Web">
...
<a href="/login_facebook" class="btn  btn-social btn-facebook btn-flat d-inline-block"><i class="fa fa-facebook"></i>Login FB</a>
<a href="/signup" class="btn  btn-social btn-google btn-flat d-inline-block"><i class="icon-key icons"></i>Tạo tài
khoản</a>
</div>
