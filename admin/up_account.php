                        ...
                        <form class="forms-sample" method="POST">
                            <div class="row form-group">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control" name="loai" value="<?= $get['name']; ?>"
                                           disabled>
                                </div>
                            </div>
                            <?php
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST">
                            <div class="form-group">
                                <label for="bulk">Thêm hàng loạt </label>
                                <textarea class="form-control" name="bulk" id="bulk" cols="30" rows="20"></textarea>
                            </div>
