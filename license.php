...
class license
{
  ...
  public function get(){ //get license
      global $db;
 ...
 public function code(){ //get key
    return $this->code;
 }
 public function expiry_date(){ //get expiry date
     return $this->expiry_date;
 } 
 public function status(){ //get status
     return $this->status;
 }
 ...
 public function update(){
     ...
     if(isset($_POST['date']) || isset($_POST['server']) || isset($_POST['secret']) || isset($_POST['key'])){
        ...
        switch($date){
            case $date == 0: $status ="Expired";  break;
            case $date > 0: $status = "Working"; break;
