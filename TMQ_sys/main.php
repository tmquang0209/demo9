                                    ...
                                    <div class="news_image">
                                        <a href="<?= $url; ?>" title="<?= $row['name']; ?>" class="">
                                            ...
                                            <style>
                                                                                    ...
                                                                                    -->
                                            <img src="<?= get_upload_url('categories', $row['image']); ?>"
                                                 alt="<?= $row['name']; ?>"></a>
                                    </div>
                ...
                <div class="row row-flex-safari game-list">
                    ...
                    foreach ($service as $row) {
                        ...
                        <div class="col-sm-3 col-xs-6 p-5">
                            <div class="classWithPad">
                                <div class="news_image">
                                    <a href="/service/<?= TMQ_xoadau($row['name']); ?>/<?= $row['id']; ?>.html"
                                       class=""><img src="<?= get_upload_url('categories', $row['image_thumb']); ?>"></a>
                                </div>
                                <div class="news_title"><a
                                            href="/service/<?= TMQ_xoadau($row['name']); ?>/<?= $row['id']; ?>.html"><?= $row['name']; ?></a>
                                </div>
                                <div class="news_description">
                                    <p>
                                        Đã quay: <?= $daquay; ?>
                                ...
                                <div class="a-more">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="view">
                                                <a href="/service/<?= TMQ_xoadau($row['name']) . '/' . $row['id']; ?>.html">Xem
                                                    tất cả</a>
                                            </div>
                                        </div>
                                    </div>
